...
for iexp, iname in zip(experiments, names):
    for imodel, iens in zip(models, ens):
        ...
        result_ds1 = functions.load_and_check_variables('ta', params)
        result_ds2 = functions.load_and_check_variables('psl', params)
        result_ds3 = functions.load_and_check_variables('ts', params)
