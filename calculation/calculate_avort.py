...
cal_var = 'absolute_vort'  # function and input in the following code need to be changed
cal_var_abbr = 'avort'
...
for iexp, iname in zip(experiments, names):
    for imodel, iens in zip(models, ens):
        ...
        result = functions.absolute_vort(result_ds1.ua.sel({f'{level_dim}':85000}), result_ds2.va.sel({f'{level_dim}':85000}))
